deepspeed --master_port 50002 run_training.py --deepspeed --llm_path  LLaMAX/LLaMAX2-7B-XNLI \
          --mt_path google/mt5-xl/ --stage_name mapping --task xnli --augmentation False \
...
deepspeed --master_port 50002 run_training.py --deepspeed --llm_path  LLaMAX/LLaMAX2-7B-XNLI \
          --mt_path google/mt5-xl/ --stage_name augmentation --task xnli --augmentation True \
