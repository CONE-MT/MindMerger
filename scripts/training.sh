...
deepspeed --master_port 50002 run_training.py --deepspeed --llm_path ../LLMs/MetaMath-7B-V1.0/ \
          --mt_path ../LLMs/mt5-xl/ --stage_name mapping --train_num 100000 --train_batch_size 128 \
...
deepspeed --master_port 50002 run_training.py --deepspeed --llm_path ../LLMs/MetaMath-7B-V1.0/ \
          --mt_path ../LLMs/mt5-xl/ --stage_name augmentation --train_num 30000 --train_batch_size 128 \
